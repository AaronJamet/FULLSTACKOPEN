...
const url =
  `mongodb+srv://fullstack:${password}@fullstackopen.ml3uoya.mongodb.net/testNoteApp?retryWrites=true&w=majority&appName=fullstackopen`
...
const note = new Note({
  content: 'Recursivity is very hard',
  important: true
})
